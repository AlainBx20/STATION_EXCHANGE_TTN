...
public class Titres implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "titres_seq_gen")
    @SequenceGenerator(name = "titres_seq_gen", sequenceName = "TITRES_SEQ", allocationSize = 1)
    @Column(name = "ID_SEQ")
    private Long idSeq;
    ...
    @Column(name = "NUMDEP")
    private java.math.BigDecimal numdep;
    ...
    private java.math.BigDecimal mntptfndev;

    @Column(name = "MNTFOBDEV", precision = 15, scale = 3)
    private java.math.BigDecimal mntfobdev;
    ...
    private java.math.BigDecimal mntptfntnd;

    @Column(name = "MNTFOBTND", precision = 15, scale = 3)
    private java.math.BigDecimal mntfobtnd;
    ...
    @Column(name = "NBRRBQ")
    private java.math.BigDecimal nbrrbq;
    ...
    private java.math.BigDecimal seqReception;
    ...
    public String getNattit() {
        return nattit;
    }

    public void setNattit(String nattit) {
        this.nattit = nattit;
    }

    public String getCoddevCnt() {
        return coddevCnt;
    }

    public void setCoddevCnt(String coddevCnt) {
        this.coddevCnt = coddevCnt;
    }

    public String getCoddevRegl() {
        return coddevRegl;
    }

    public void setCoddevRegl(String coddevRegl) {
        this.coddevRegl = coddevRegl;
    }
    ...
    public String getCodregstat() {
        return codregstat;
    }

    public void setCodregstat(String codregstat) {
        this.codregstat = codregstat;
    }

    public Date getDatdom() {
        return datdom;
    }

    public void setDatdom(Date datdom) {
        this.datdom = datdom;
    }

    public java.math.BigDecimal getNumdep() {
        return numdep;
    }

    public void setNumdep(java.math.BigDecimal numdep) {
        this.numdep = numdep;
    }
    ...
    public Date getDatcnt() {
        return datcnt;
    }

    public void setDatcnt(Date datcnt) {
        this.datcnt = datcnt;
    }

    public java.math.BigDecimal getMntptfndev() {
        return mntptfndev;
    }

    public void setMntptfndev(java.math.BigDecimal mntptfndev) {
        this.mntptfndev = mntptfndev;
    }

    public java.math.BigDecimal getMntfobdev() {
        return mntfobdev;
    }

    public void setMntfobdev(java.math.BigDecimal mntfobdev) {
        this.mntfobdev = mntfobdev;
    }
    ...
    public void setLibfrs(String libfrs) {
        this.libfrs = libfrs;
    }
    ...
    public java.math.BigDecimal getMntptfntnd() {
        return mntptfntnd;
    }

    public void setMntptfntnd(java.math.BigDecimal mntptfntnd) {
        this.mntptfntnd = mntptfntnd;
    }

    public java.math.BigDecimal getMntfobtnd() {
        return mntfobtnd;
    }

    public void setMntfobtnd(java.math.BigDecimal mntfobtnd) {
        this.mntfobtnd = mntfobtnd;
    }

    public Date getDatdepaut() {
        return datdepaut;
    }

    public void setDatdepaut(Date datdepaut) {
        this.datdepaut = datdepaut;
    }

    public Date getDatenrgmin() {
        return datenrgmin;
    }

    public void setDatenrgmin(Date datenrgmin) {
        this.datenrgmin = datenrgmin;
    }

    public String getNumenrgmin() {
        return numenrgmin;
    }

    public void setNumenrgmin(String numenrgmin) {
        this.numenrgmin = numenrgmin;
    }

    public Date getDatfintit() {
        return datfintit;
    }

    public void setDatfintit(Date datfintit) {
        this.datfintit = datfintit;
    }
    ...
    public String getNumdepext() {
        return numdepext;
    }

    public void setNumdepext(String numdepext) {
        this.numdepext = numdepext;
    }
    ...
    public String getCoddou() {
        return coddou;
    }

    public void setCoddou(String coddou) {
        this.coddou = coddou;
    }

    public String getCodugdep() {
        return codugdep;
    }

    public void setCodugdep(String codugdep) {
        this.codugdep = codugdep;
    }

    public String getCodburdou() {
        return codburdou;
    }

    public void setCodburdou(String codburdou) {
        this.codburdou = codburdou;
    }

    public String getNumdecldou() {
        return numdecldou;
    }

    public void setNumdecldou(String numdecldou) {
        this.numdecldou = numdecldou;
    }

    public Date getDatdecldou() {
        return datdecldou;
    }

    public void setDatdecldou(Date datdecldou) {
        this.datdecldou = datdecldou;
    }
    ...
    public String getCodpayAchDestdeb() {
        return codpayAchDestdeb;
    }

    public void setCodpayAchDestdeb(String codpayAchDestdeb) {
        this.codpayAchDestdeb = codpayAchDestdeb;
    }

    public String getCodpayProvDestfin() {
        return codpayProvDestfin;
    }

    public void setCodpayProvDestfin(String codpayProvDestfin) {
        this.codpayProvDestfin = codpayProvDestfin;
    }

    public java.math.BigDecimal getNbrrbq() {
        return nbrrbq;
    }

    public void setNbrrbq(java.math.BigDecimal nbrrbq) {
        this.nbrrbq = nbrrbq;
    }
    ...
    public String getNumDemandeTtn() {
        return numDemandeTtn;
    }

    public void setNumDemandeTtn(String numDemandeTtn) {
        this.numDemandeTtn = numDemandeTtn;
    }
    ...
    public java.math.BigDecimal getSeqReception() {
        return seqReception;
    }

    public void setSeqReception(java.math.BigDecimal seqReception) {
        this.seqReception = seqReception;
    }
    ...
    public String getIndTransact() {
        return indTransact;
    }

    public void setIndTransact(String indTransact) {
        this.indTransact = indTransact;
    }

    public String getNumDossTtnOrig() {
        return numDossTtnOrig;
    }

    public void setNumDossTtnOrig(String numDossTtnOrig) {
        this.numDossTtnOrig = numDossTtnOrig;
    }

    public String getNumDemandeTtnOrig() {
        return numDemandeTtnOrig;
    }

    public void setNumDemandeTtnOrig(String numDemandeTtnOrig) {
        this.numDemandeTtnOrig = numDemandeTtnOrig;
    }

    public String getNumMessageOrig() {
        return numMessageOrig;
    }

    public void setNumMessageOrig(String numMessageOrig) {
        this.numMessageOrig = numMessageOrig;
    }

    public String getAperakEnvoye() {
        return aperakEnvoye;
    }

    public void setAperakEnvoye(String aperakEnvoye) {
        this.aperakEnvoye = aperakEnvoye;
    }
    ...
    public String getCodpayTier() {
        return codpayTier;
    }

    public void setCodpayTier(String codpayTier) {
        this.codpayTier = codpayTier;
    }
