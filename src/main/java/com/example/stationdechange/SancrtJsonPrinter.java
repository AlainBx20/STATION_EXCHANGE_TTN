...
public class SancrtJsonPrinter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            // --- CUSRES ---
            processCusresDocument();
            
            // --- APERAK ---
            processAperakDocument();
            
            logger.info("Document processing completed successfully");
            
        } catch (Exception e) {
            logger.error("Error during document processing", e);
            logger.info("Application will continue running despite Kafka errors");
        }
    }
    
    private void processSancrtDocument() {
        try {
    ...
    private void processCusresDocument() {
        try {
            ...
            if (imputations != null) {
                ...
                try {
                    ...
                    String json = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(cusresDto);
    ...
    public void processAperakDocument() {
        try {
